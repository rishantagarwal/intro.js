   ...
   */
	function _placeTooltip(
		...
		switch (currentTooltipPosition) {
			case "top":
				console.log("TOP ATTRIBUTE FOUND") //TODO:action response test
				...
				break
			case "right":
				console.log("RIGHT ATTRIBUTE FOUND") //TODO:action response test
				...
				break
			case "left":
				console.log("LEFT ATTRIBUTE FOUND") //TODO:action response test
				...
				break
			case "left-right-bottom-33": // Left-Box, Arrow-right-from-bottom-33%
				console.log("left-right-bottom-33(%) ATTRIBUTE FOUND") //TODO:action response test
				if (!hintMode && this._options.showStepNumbers == true) {
					tooltipLayer.style.top = "15px"
				}
				...
				arrowLayer.className = "introjs-arrow right-bottom-33"
				tooltipLayer.style.right = targetOffset.width + 20 + "px"
				break
			case "floating":
				console.log("floating ATTRIBUTE FOUND") //TODO:action response test
			...
			case "bottom-right-aligned":
				console.log("bottom-right-aligned ATTRIBUTE FOUND") //TODO:action response test
			...
			case "bottom-middle-aligned":
				console.log("bottom-middle-aligned ATTRIBUTE FOUND") //TODO:action response test
			...
			case "bottom-top-right-15-sp":
				console.log(
					"bottom-top-right-15(%) + specialNumberLayer ATTRIBUTE FOUND"
				) //TODO:action response test
				...
				tooltipLayer.style.top = targetOffset.height + 20 + "px"
				arrowLayer.className = "introjs-arrow top-right-15" // adj arrow position

				helperNumberLayer.style.top = "12px"
				helperNumberLayer.style.left = "107px"
				break

			case "bottom-top-right-40-sp":
				console.log(
					"bottom-top-right-40(%) + specialNumberLayer ATTRIBUTE FOUND"
				) //TODO:action response test
				arrowLayer.className = "introjs-arrow top"
				...
				tooltipLayer.style.top = targetOffset.height + 20 + "px"
				arrowLayer.className = "introjs-arrow top-right-40" // adj arrow position

				helperNumberLayer.style.top = "0px"
				helperNumberLayer.style.left = "-20px"
				break
			...
			default:
				console.log("BOTTOM ATTRIBUTE FOUND") //TODO:action response test
				arrowLayer.className = "introjs-arrow top"
